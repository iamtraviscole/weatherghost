...
export const dayOfMonthIsToday = (unix1, unix2, unixOffset) => {
  const day1 = dayjs.unix(unix1 + unixOffset).utc(true).date()
  const day2 = dayjs.unix(unix2 + unixOffset).utc(true).date()
